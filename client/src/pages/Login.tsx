...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-between bg-slate-50 dark:bg-[#0B0F19] text-slate-900 dark:text-slate-100 p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center py-10 z-10">
        ...
        >
          <div className="text-center space-y-2">
            <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">Welcome back</h1>
            <p className="text-xs text-slate-500 dark:text-slate-400">Sign in to manage your tasks.</p>
          </div>
          ...
          <p className="text-center text-xs text-slate-500 dark:text-slate-400 pt-2">
            ...
            <Link to="/register" className="font-bold text-indigo-600 dark:text-indigo-400 hover:underline">Create an account</Link>
          </p>
        </motion.div>
      </div>
